...
- Install the latest vender library for phoenix using the following link: [https://maven.ctr-electronics.com/release/com/ctre/phoenix/Phoenix5-frc2023-latest.json](https://maven.ctr-electronics.com/release/com/ctre/phoenix/Phoenix5-frc2023-latest.json).
- gradle build
- done.
